...
data Obstaculo
  = Nenhum -- ^ a ausência de obstáculos na 'Relva'
  | NenhumT -- ^ a ausência de obstáculos no 'Rio'
  | NenhumC -- ^ a ausência de obstáculos na 'Estrada'
  | Tronco -- ^ os troncos deslizam apenas em 'Rio'
  | Carro -- ^ os carros movimentam-se apenas em 'Estrada'
  | CarroVP -- ^ carro velocidade positiva
  | AutocarroF 
  | AutocarroT 
