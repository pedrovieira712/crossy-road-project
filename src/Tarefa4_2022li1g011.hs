...
-}
module Tarefa4_2022li1g011 where
...
{-| 
A função __jogoTerminou__ que recebe um Jogo e uma jogada que "dá" um Booleano sendo se for __True__ o jogo terá terminado e se for __False__ o 
...
jogadorForaMapa (Jogo (Jogador (x,y)) (Mapa l ((t,(o:os)):r))) | x < 0 || x > l-1 || y < 0 || y > (length (listaTerrenos ((t,(o:os)):r)))-1 = True
                                                               | otherwise = False

jogadorMortoObstaculo :: Jogo -> Bool
jogadorMortoObstaculo (Jogo (Jogador (x,y)) (Mapa l ((Rio v,(o:os)):r))) | (o:os) !! x == Nenhum = True
                                                                              | otherwise = False
...
linhaY (Jogo (Jogador (x,y)) (Mapa l ((t,(o:os)):r))) = ((t,(o:os)):r) !! y 
